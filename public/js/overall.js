function drawChart(reg_user_first_year, reg_user_num_rev, admin_user_first_year, admin_user_num_rev) {
    var data_temp = [['Year', 'admin', 'reg_user']];
    ...
    var num_len_array = [reg_user_num_rev_len, admin_user_num_rev_len];
    ...
    for(var i=0;i<max_len;i++){
        ...
        data_temp.push([year,admin_num_of_rev,reg_num_of_rev]);
    ...
    var chart = new google.charts.Bar(document.getElementById('chart_one_result'));
    ...
    $("#show").click(function(event){
        ...
        $.getJSON('/showDataForOverallBarChartRegUser',null, function(reg_revision) {
            ...
            $.getJSON('/showDataForOverallBarChartAdminUser',null, function(admin_revision){
                ...
                var admin_user_first_year = admin_revision[0]._id.year;
                drawChart(reg_user_first_year, reg_user_num_rev, admin_user_first_year, admin_user_num_rev);
